                    ...
                    <div class="notification d-flex">
                                    ...
                                    <li class="online">
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="message">There are many variations of passages of Lorem Ipsum
                                                </div>
                                    ...
                                    <li class="offline">
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="message">Contrary to popular belief, Lorem Ipsum is not simply
                                                </div>
                                    ...
                                    <li class="online">
                                        <a href="javascript:void(0);" class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="message">It has roots in a piece of classical Latin literature
                                                    from 45 BC</div>
                        ...
                        <div class="dropdown d-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i class="dropdown-icon fe fe-send"></i>
                                    Message</a>
                                <div class="dropdown-divider"></div>
